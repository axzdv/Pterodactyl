...
cdn="https://raw.githubusercontent.com/axzdv/Pterodactyl/main/src/"
...
installPanel() {
  cd
    ...
    curl -o /etc/mysql/my.cnf $cdn/my.cnf
    curl -o /etc/mysql/mariadb.conf.d/50-server.cnf $cdn/50-server.cnf
    ...
    curl -o /etc/systemd/system/pteroq.service $cdn/pteroq.service

    systemctl enable --now redis-server
    systemctl enable --now pteroq.service
    
    curl -o /etc/nginx/sites-enabled/pterodactyl.conf $cdn/$Pterodactyl_conf
...
installWings() {
    ...
    curl -o /etc/default/grub $cdn/grub
    update-grub
    ...
    curl -o /etc/systemd/system/wings.service $cdn/wings.service
    echo > config.yml
    cd
}
...
installPhpMyAdmin() {
    ...
    curl -o /var/www/pterodactyl/public/pma/config.inc.php $cdn/config.inc.php
